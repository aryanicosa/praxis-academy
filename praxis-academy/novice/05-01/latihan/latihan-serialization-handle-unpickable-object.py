# menggunakan getstate() dan setstate() untuk 
# re-initialize (selama process pickling) object yg belum di pickle
...
class My_zen_class():
    ...
    def __getstate__(self):
        # method ini dipanggil ketika akan pickle class 
        # untuk mengetahui apa yang akan di pickle
